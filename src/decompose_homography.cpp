...
const char* params
    = "{ help h         |       | print usage }"
      "{ image1         | ../test_imgs/left02.jpg | path to the source chessboard image }"
      "{ image2         | ../test_imgs/left01.jpg | path to the desired chessboard image }"
      "{ intrinsics     | ../test_imgs/left_intrinsics.yml | path to camera intrinsics }"
